...
System CreateSolarSystem()
{
	...
	std::vector<ObjectHelper> planets = {
		...
		ObjectHelper("Jupiter",		"Sun",		69911,		5.2042,		4332.589,	"15.8.2022"),
		ObjectHelper("Mercury",		"Sun",		2440,		0.387,		87.969,		"20.12.2022"),
		ObjectHelper("Venus",		"Sun",		6052,		0.723,		224.701,	"26.1.2023"),
		ObjectHelper("Earth",		"Sun",		6370,		1,			365.256,	"23.9.2022"),
		ObjectHelper("Mars",		"Sun",		3396,		1.5235,		686.98,		"13.7.2022"),
		ObjectHelper("Saturn",		"Sun",		60268,		9.582,		10759.22,	"23.10.2025"),
		ObjectHelper("Uranus",		"Sun",		25559,		19.229,		30685.4,	"22.1.2012"),
		ObjectHelper("Neptune",		"Sun",		24764,		30.104,		60190,		"4.10.2025")
	};
	...
	std::vector<ObjectHelper> moons = {
		//			 name			parent		radius		distance	siderial	equinox	
		ObjectHelper("Moon",		"Earth",	1738,		0.00257,	27.3217,	"2.12.2022")
	};
